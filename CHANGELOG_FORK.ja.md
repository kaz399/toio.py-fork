...
- `e5b6d13`: `set_collision_detection_threshold()` を修正しました。
- `a0fd102`, `7d12485`, `846c52f`: README sample code を修正しました。
- `b1e3ac6`: package management を Poetry から uv に移行しました。
- `b58637b`: Bleak connection state handling を修正し、definition-only test を改善しました。
- `af1a598`: `e5b6d13` の collision threshold 修正に対する regression test を追加しました。
- `871313a`: [toio/toio.py#14](https://github.com/toio/toio.py/issues/14) に対して、`CubeInfo` からの `ToioCoreCube` 初期化を修正しました。
- `6c07f21`: [toio/toio.py#15](https://github.com/toio/toio.py/issues/15) に対して、scanner strategy を追加しました。
- `fbf96d7`: `toio.py-fork` 用に distribution 名と documentation reference を変更しました。
- `b2fabe3`: この fork changelog を追加しました。
